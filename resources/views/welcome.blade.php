...
<head> 
    ...
    <title>Hotel and Bed&amp;Breakfast</title>
...
<body>
                            ...
                            <div id="container_4">
                                ...
                                <div class="qty-buttons">
                                  <input type="text" list="browsers" value="" class="form-control">
                                    <datalist id="browsers" style="width:150px;height:150px;">
                                       <option id="childrenNum"value="Chrome">
                                    </datalist>
                                </div>
                            </div>
                        </div><!-- End group_2 -->
    ...
    <div class="container margin_60_35">
        <h1 class="main_title"><em></em>Welcome<span>Hotel and Bed&amp;Breakfast</span></h1>
        <p class="lead styled">
