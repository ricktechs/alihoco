              ...
              <input type="hidden" name="csrf_souq" value="24ca6f089392596aef1db42703bbf21c" />
                ...
                <div class="row">
                  <div class="col-lg-4" style="border-right: 1px solid #d4d4d4;">
                        <label style="position:relative;top:14px;left:13px;z-index: 111111;">Hotel Name</label>
                    ...
                    <option value="{!! $values->node->destinationData->texts['text'] !!}">{!! $values->node->destinationData->texts['text'] !!}</option>
                        @endforeach
                    </select>
